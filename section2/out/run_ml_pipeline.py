...
if __name__ == "__main__":
    ...
    split['train'], split['test'] = train_test_split(keys, test_size=.2, random_state=21)
    split['train'], split['val'] = train_test_split(split['train'], test_size=.2, random_state=21)
